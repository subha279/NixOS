...
#
# Safety:
#   - Never deletes the current generation
#   - Never modifies your flake
#   - Never modifies Home Manager configuration
#   - Never uses nix-collect-garbage -d
#   - Always performs a dry-build before cleanup
#
# ============================================================
