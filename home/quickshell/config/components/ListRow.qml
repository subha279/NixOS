...
// ListRow
// ----------------------------------------------------------------
// One selectable row inside a popup: leading icon, title,
// subtitle, optional trailing badge, hover state, busy spinner,
// left-click activation and right-click context request.
// ================================================================
