...
Components.PopupSurface {
    ...
    readonly property int daysInMonth:
        new Date(popup.viewYear, popup.viewMonth + 1, 0).getDate()
    ...
    function isToday(day) {
        ...
        return popup.viewYear === popup.now.getFullYear()
            && popup.viewMonth === popup.now.getMonth()
            && day === popup.now.getDate()
    }
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Text {
                        ...
                        color: (parent.index === 5 ||
                                parent.index === 6)
                            ? Core.Theme.accentSoft
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    readonly property int day:
                        popup.dayFor(dayCell.index)

                    readonly property bool filled:
                        dayCell.day > 0

                    readonly property bool today:
                        popup.isToday(dayCell.day)
