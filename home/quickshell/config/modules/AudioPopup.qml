...
Components.PopupSurface {
    ...
    function deviceMenu(node, mx, my) {
        ...
        popup.openMenu(mx, my, [
            ...
            {
                label: svc.mutedOf(target)
                    ? "Unmute"
                    : "Mute",
                icon: svc.mutedOf(target)
                    ? svc.iconHigh
                    : svc.iconOff,
                action: function() {
    ...
    Column {
        ...
        Components.PopupHeader {
            ...
            subtitle: popup.svc.sink
                ? popup.svc.label(popup.svc.sink)
                : "No output device"
        ...
        Item {
            ...
            height: popup.showOutputs
                ? Math.min(outputList.implicitHeight, 190)
                : 0
            ...
            Column {
                ...
                Repeater {
                    ...
                    delegate: Components.ListRow {
                        ...
                        subtitle: popup.svc.percentOf(
                            sinkRow.modelData) + "%" +
                            (popup.svc.mutedOf(sinkRow.modelData)
                                ? "  \u00b7  muted"
                                : "")

                        active: popup.svc.isDefault(
                            sinkRow.modelData)

                        trailing: sinkRow.active
                            ? "\udb80\udd34"
                            : ""
                        ...
                        onActivated: {
                            popup.svc.setDefaultSink(
                                sinkRow.modelData)
                        }

                        onContextRequested: function(mx, my) {
                            popup.deviceMenu(
                                sinkRow.modelData, mx, my)
                        }
                    }
                }
            }
        ...
        Item {
            ...
            height: popup.showInputs
                ? Math.min(inputList.implicitHeight, 190)
                : 0
            ...
            Column {
                ...
                Repeater {
                    ...
                    delegate: Components.ListRow {
                        ...
                        subtitle: popup.svc.percentOf(
                            sourceRow.modelData) + "%" +
                            (popup.svc.mutedOf(sourceRow.modelData)
                                ? "  \u00b7  muted"
                                : "")
                        ...
                        onActivated: {
                            popup.svc.setDefaultSource(
                                sourceRow.modelData)
                        }

                        onContextRequested: function(mx, my) {
                            popup.deviceMenu(
                                sourceRow.modelData, mx, my)
                        }
                    }
                }
            }
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Components.VolumeSlider {
                        ...
                        value: popup.svc.volumeOf(
                            streamRow.modelData)

                        muted: popup.svc.mutedOf(
                            streamRow.modelData)
