{
  ...
  global = {
    ...
    ui = {
      ...
      # Previously hardcoded in core/Theme.qml, which meant the one opacity
      # knob exposed here (windowOpacity) did not control the shell.
      glassOpacity = 0.80;
  ...
  # Accuracy notes:
  #
  #   • terminal* values follow each project's OFFICIAL ANSI mapping. Several
  #     upstreams (Catppuccin, Nord, One Dark, Everforest, Rosé Pine) reuse
  #     the normal colour in the bright slot on purpose.
  #   • Where an upstream defines no hover/active surface tone, the value is
  #     interpolated between the two nearest official palette entries.
  #   • aurora and monochrome are custom; they have no upstream spec.
  #
  # ==========================================================================
  ...
  themes = {
    ...
    solarized-dark = {
      ...
      colors = {
        ...
        # Solarized's official ANSI mapping deliberately reuses the base
        # greys for bright green/yellow/blue/cyan. This is the spec.
